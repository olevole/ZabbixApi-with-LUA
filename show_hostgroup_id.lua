...
local reqbody = '{"jsonrpc":"2.0","method": "hostgroup.get","params": {"output": "extend", "sortfield": "name"},"auth":"superpass","id":0}'
...
for k,v in pairs ( t ) do
	if ( k == "result" and type(v) == "table" ) then
		for x,y in pairs ( v ) do
			...
			table.insert(tgroupid,groupid)
		end
	end
end

for a,b in pairs ( tnames ) do
	print ( tnames[a] .. "|" .. tgroupid[a] )
end
